# Naly Tic-Tac-Toe - CES210 - Week 01 Prove: Developer
...
# This function introduces the rules of the game Tic Tac Toe
    ...
    print("\n")
    print("The game is played on a grid tht is three squares by three squares.")
    print("Player one uses x's. Player two uses o's")
    print("The first player to get three of theri marks in a row (verticall, horizontally, or diagonally) is the winner.")
